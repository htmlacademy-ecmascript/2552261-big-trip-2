...
function createEventHeaderTemplate({point, type, types}) {
...
function createPointEditTemplate({point, type, offers, destination, types}) {
  return `<li class="trip-events__item">
<form class="event event--edit" action="#" method="post">
${createEventHeaderTemplate({point, type, types})}
...
export default class PointFormView {
  ...
  constructor({point, type, destination, offers, types} = {}) {
  ...
  getTemplate() {
    return createPointEditTemplate({
      ...
      offers: this.offers, destination: this.destination, types: this.types
    });
  }
